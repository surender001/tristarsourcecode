...
uint256 hashGenesisBlock("0x0000055632129614106601bc9388215782b25793977aeb5c8778d38ae49089f1");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // tristar: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "tristar Signed Message:\n";
...
{
    // tristar: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // tristar: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "tristar genesis block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1487802351;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1728503;
        ...
        assert(block.hashMerkleRoot == uint256("0x84cd1b1a5d6f85f7de94236513b6e21cfe755216f223f44fcccf567527792fbf"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // tristar: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("tristarMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("tristarMiner : ProcessBlock, block not accepted");
    }

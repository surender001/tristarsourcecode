...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "tristar " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"159.203.98.180", "159.203.98.180"},
	{"159.203.112.182", "159.203.112.182"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. tristar is probably already running."), addrBind.ToString().c_str());
        else
